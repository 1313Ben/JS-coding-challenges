// Third Greatest
// Have the function ThirdGreatest(strArr) take the array of strings stored
// in strArr and return the third largest word within it.
...
//   after because the first three words are all 5 letters long,
...
function ThirdGreatest(strArr) {
  return strArr.sort(function(a, b) { return b.length - a.length; })[2]; // sort after element lengths and returns the third element
}
